...
router.get("/", function (req, res) {
  Solucion.find({}, function (err, solucion) {
    Videos.populate(solucion, { path: "Video" }, function (err, solucion) {
      res.status(200).send(solucion);
    });
  });
});

//obtener la solucion por id
